...
public class AdminVO {
	...
	private boolean AdminDeleteMember;
	...
	private boolean AdminDeleteFestival;
	private boolean AdminDeleteBoard;
	...
	public boolean isAdminDeleteMember() {
		return AdminDeleteMember;
	}
	public void setAdminDeleteMember(boolean adminDeleteMember) {
		AdminDeleteMember = adminDeleteMember;
	}
	public boolean isAdminDeleteFestival() {
		return AdminDeleteFestival;
	}
	public void setAdminDeleteFestival(boolean adminDeleteFestival) {
		AdminDeleteFestival = adminDeleteFestival;
	}
	public boolean isAdminDeleteBoard() {
		return AdminDeleteBoard;
	}
	public void setAdminDeleteBoard(boolean adminDeleteBoard) {
