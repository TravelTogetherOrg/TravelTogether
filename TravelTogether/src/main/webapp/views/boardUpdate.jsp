        ...
        <form action="updateBoard.do" method="post" enctype="multipart/form-data">
            ...
            <section><!--축제/인원/날짜 선택--> 
                <div class="chooseDetail">
                    <div id="festivalByRegion">
                    	${board.festival_name}
                        <%-- <input type="text" value="${board.festival_name}" readonly> --%>
                    </div>
            ...
            <div><!--이미지/내용-->
                <div class="writeImage">
                    ...
                    <div class="writeImageInfo" style="background-image: url('${context}/resources/image/board/boardImage/${board.board_image_file_path}/${board.board_image_file}');">
                        <!-- 
            ...
            <div class="buttons"><!--취소 / 올리기 버튼-->
                ...
                <button class="submitButton" type="button" onclick="updateCheck()">수정완료</button>
            </div>
        </form>
        </section>
    </main>
