<<<<<<< Updated upstream:TravelTogether/TravelTogether/src/main/webapp/views/boardWrite.jsp
...
<jsp:include page="header.jsp"/>
    ...
    <main class="container-md">
        <section>
         <%-- <form:form modelAttribute="boardVO" action="insertBoard.do" enctype="multipart/form-data"> --%>
            <form action="insertBoard.do" id="form" method="post">
            <section><!--축제/인원/날짜 선택--> 
                <div class="chooseDetail">
                    <div class="selectFestival">
                        <div>
                    ...
                    <div class="peopleAndDate"><!--인원수/날짜-->
                        ...
                        <div class="date">
                            ...
                            <input type="date" name="board_start_date" required>
                            <div id="lastDay">
                                <span>~</span>
                                <input type="date">
                            </div>
            ...
            <div><!--이미지/내용 입력-->
                ...
                <div class="writeTitle">
                	<%-- <form:input path="board_title" placeholder="ex) 8월 펜타포트 같이 갈 동행 3명 구해요"/> --%>
                    <input type="text" name="board_title" id="board_title" placeholder="ex) 8월 펜타포트 같이 갈 동행 3명 구해요" maxlength="100">
                </div>
                <div class="writeContent">
                <%-- 
                	<form:textarea path="boardContent" placeholder="1. 현재 동행이 있나요? 
ex) 혼자에요 / 동행 1명이 있어요 
...
>>>>>>> Stashed changes:TravelTogether/src/main/webapp/views/boardWrite.jsp
</html>